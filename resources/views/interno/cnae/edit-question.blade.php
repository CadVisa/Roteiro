    ...
    <div class="container-fluid">
        ...
        <div class="card border-primary border-ligth shadow mb-3 mt-3 col-md-12">
            ...
            <div class="card-header d-flex justify-content-between align-items-center border-primary text-light bg-primary">
                ...
                <div>
                    <a href="{{ route('cnae.show', ['cnae' => $pergunta->cnae_id]) }}" class="spinner-light btn btn-sm btn-outline-light">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('cnae.update-question', ['pergunta' => $pergunta->id]) }}" method="POST" class="row needs-validation novalidate">
                    @csrf
                    @method('POST')

                    <div class="col-12 mb-3">
                        <span class="fw-bold">Código:</span><span> {{ $pergunta->cnae->codigo_cnae }}</span>
                    </div>

                    <div class="col-12 mb-3">
                        <span class="fw-bold">Descrição:</span><span> {{ $pergunta->cnae->descricao_cnae }}</span>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control @error('pergunta') is-invalid @enderror" type="text" name="pergunta"
                            id="pergunta" placeholder="Descrição da pergunta" autocomplete="off">{{ old('pergunta', $pergunta->pergunta) }}</textarea>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-3">
                        ...
                        <select class="form-control @error('competencia') is-invalid @enderror" name="competencia" id="competencia">
                            ...
                            <option value="Municipal" @if (old('competencia', $pergunta->competencia) == 'Municipal') selected @endif>Municipal</option>
                            <option value="Estadual" @if (old('competencia', $pergunta->competencia) == 'Estadual') selected @endif>Estadual</option>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-3">
                        ...
                        <select class="form-control @error('grau_sim') is-invalid @enderror" name="grau_sim" id="grau_sim">
                            ...
                            <option value="Baixo risco" @if (old('grau_sim', $pergunta->grau_sim) == 'Baixo risco') selected @endif>Baixo risco</option>
                            <option value="Médio risco" @if (old('grau_sim', $pergunta->grau_sim) == 'Médio risco') selected @endif>Médio risco</option>
                            <option value="Alto risco" @if (old('grau_sim', $pergunta->grau_sim) == 'Alto risco') selected @endif>Alto risco</option>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-3">
                        ...
                        <select class="form-control @error('grau_nao') is-invalid @enderror" name="grau_nao" id="grau_nao">
                            ...
                            <option value="Baixo risco" @if (old('grau_nao', $pergunta->grau_nao) == 'Baixo risco') selected @endif>Baixo risco</option>
                            <option value="Médio risco" @if (old('grau_nao', $pergunta->grau_nao) == 'Médio risco') selected @endif>Médio risco</option>
                            <option value="Alto risco" @if (old('grau_nao', $pergunta->grau_nao) == 'Alto risco') selected @endif>Alto risco</option>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <a href="{{ route('cnae.show', ['cnae' => $pergunta->cnae_id]) }}" class="spinner-danger btn btn-outline-danger btn-sm me-1">
