        ...
        <div class="card border-primary border-ligth shadow mb-3 mt-3 col-md-12">
            ...
            <div class="card-header d-flex justify-content-between align-items-center border-primary text-light bg-primary">
                <span class="me-auto">
                    ...
                    Detalhes das políticas de privacidade
                </span>
                ...
                <div class="d-flex justify-content-between align-items-center gap-2">
                    ...
                    <a class="btn btn-sm btn-outline-light" href="{{ route('documento.editPolitica', ['documento' => $documento->id]) }}">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <span> {!! $documento->politica_privacidade !!}</span>
                    </div>
                </div>
            </div>
        </div>
