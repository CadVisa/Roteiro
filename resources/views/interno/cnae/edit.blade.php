    ...
    <div class="container-fluid">
        ...
        <div class="card border-primary mb-3 mt-3 border-ligth shadow col-md-12">
            ...
            <div class="card-header d-flex justify-content-between align-items-center border-primary text-light bg-primary">
                <span>Editar atividade econômica</span>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('cnae.update', ['cnae' => $cnae->id]) }}" method="POST" class="row g-3 needs-validation novalidate">
                    @csrf
                    @method('POST')
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <input class="form-control @error('codigo_cnae') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('codigo_cnae', $cnae->codigo_cnae) }}" autocomplete="off">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('descricao_cnae') is-invalid @enderror" type="text" name="descricao_cnae"
                            id="descricao_cnae" placeholder="Descrição do CNAE" autocomplete="off">{{ old('descricao_cnae', $cnae->descricao_cnae) }}</textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mt-3">
                        ...
                        <select class="form-control @error('competencia') is-invalid @enderror" name="competencia" id="competencia">
                            <option value="" @if (old('competencia', $cnae->competencia) == '') selected @endif disabled>Selecione</option>
                            <option value="Municipal" @if (old('competencia', $cnae->competencia) == 'Municipal') selected @endif>Municipal</option>
                            <option value="Estadual" @if (old('competencia', $cnae->competencia) == 'Estadual') selected @endif>Estadual</option>                            
                            <option value="Depende de informação" @if (old('competencia', $cnae->competencia) == 'Depende de informação') selected @endif>Depende de informação</option>
                            <option value="CNAE isento" @if (old('competencia', $cnae->competencia) == 'CNAE isento') selected @endif>Isento</option>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mt-3">
                        ...
                        <select class="form-control @error('grau_cnae') is-invalid @enderror" name="grau_cnae" id="grau_cnae">
                            <option value="" @if (old('grau_cnae', $cnae->grau_cnae) == '') selected @endif disabled>Selecione</option>
                            <option value="Baixo risco" @if (old('grau_cnae', $cnae->grau_cnae) == 'Baixo risco') selected @endif>Baixo risco</option>
                            <option value="Médio risco" @if (old('grau_cnae', $cnae->grau_cnae) == 'Médio risco') selected @endif>Médio risco</option>
                            <option value="Alto risco" @if (old('grau_cnae', $cnae->grau_cnae) == 'Alto risco') selected @endif>Alto risco</option>
                            <option value="Depende de informação" @if (old('grau_cnae', $cnae->grau_cnae) == 'Depende de informação') selected @endif>Depende de informação</option>
                            <option value="CNAE isento" @if (old('grau_cnae', $cnae->grau_cnae) == 'CNAE isento') selected @endif>Isento</option>
                        </select>
                        <div class="invalid-feedback">
