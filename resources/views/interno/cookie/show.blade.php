    ...
    <div class="container-fluid">
        ...
        <div class="card border-primary border-ligth shadow mb-3 mt-3 col-md-12">
            ...
            <div class="card-header d-flex justify-content-between align-items-center border-primary text-light bg-primary">
                ...
                <span class="me-auto">Detalhes do cookie</span>

                <div class="d-flex align-items-center gap-2">
                    <span>
                        <a href="{{ route('cookie.index') }}" class="spinner-light btn btn-sm btn-outline-light">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                        <span class="fw-bold">Data:</span><span>
                            {{ \Carbon\Carbon::parse($cookie->created_at)->format('d/m/Y H:i:s') }}</span>
                    </div>

                    <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                        <span class="fw-bold">ID:</span><span> {{ $cookie->id }}</span>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                        <span class="fw-bold">IP:</span><span> {{ $cookie->ip }}</span>
                    </div>

                    <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                        <span class="fw-bold">Versão:</span><span> {{ $cookie->documentoLegal->id ?? '--' }}</span>
                    </div>

                    <div class="col-sm-12 col-md-12 mb-3">
                        <span class="fw-bold">Navegador:</span><span> {{ $cookie->user_agent }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            ...
                            <div class="text-justify">{{ \Carbon\Carbon::parse($log->log_data)->format('d/m/Y H:i:s') }}
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <a href="{{ route('logs.alterar', ['log' => $log->id]) }}" class="text-decoration-none">
                                @if ($log->log_nivel == 4)
                                    <i class="fas fa-circle-check text-success me-1" title="Resolvido"></i><span
                                        class="text-success">Resolvido</span>
                                @elseif ($log->log_nivel == 1)
                                    <i class="fas fa-circle-info text-primary me-1" title="Normal"></i><span
                                        class="text-primary">Normal</span>
                                @elseif ($log->log_nivel == 2)
                                    <i class="fas fa-exclamation-circle text-warning me-1" title="Importante"></i></i><span
                                        class="text-warning">Importante</span>
                                @elseif ($log->log_nivel == 3)
                                    <i class="fas fa-triangle-exclamation text-danger me-1" title="Crítico"></i></i><span
                                        class="text-danger">Crítico</span>
                                @endif
                            </a>
                        </div>
