    ...
    <div class="container-fluid">
        ...
        <div class="card border-primary border-ligth shadow mb-3 mt-3 col-md-12">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('card.store') }}" method="POST" class="row g-3 needs-validation novalidate">
                    @csrf
                    @method('POST')
                    ...
                    <div class="col-sm-12">
                        ...
                        <input class="form-control @error('card_titulo') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('card_titulo') }}" autocomplete="off">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('card_descricao') is-invalid @enderror" type="text" name="card_descricao"
                            id="card_descricao" placeholder="Descrição do card" autocomplete="off">{{ old('card_descricao') }}</textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input class="form-control @error('card_icone') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('card_icone') }}" autocomplete="off">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input class="form-control @error('card_ordem') is-invalid @enderror" type="number"
                            ...
                            value="{{ old('card_ordem') }}" autocomplete="off">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select class="form-control @error('card_status') is-invalid @enderror" name="card_status" id="card_status">
                            ...
                            <option value="Ativo" @if (old('card_status') == 'Ativo') selected @endif>Ativo</option>
                            <option value="Inativo" @if (old('card_status') == 'Inativo') selected @endif>Inativo</option>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <a href="{{ route('card.index') }}" class="spinner-danger btn btn-outline-danger btn-sm me-1">
